...
function mouseDown() {
    elmt1.style.height = "499px";
	
	switch (numvais) {
		case 1 : figure1.style.width = "400px" ; figure1.style.height = "270px" ; break ;
...
function mouseUp() {
    elmt1.style.height = "498px";
	
	switch (numvais) {
		case 1 : figure1.style.width = "401px" ; figure1.style.height = "271px" ; break ;
